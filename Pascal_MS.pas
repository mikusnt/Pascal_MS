...
procedure zmiana_hasla(haslo_popr:string);
        ...
        begin
                ...
                repeat
                        ...
                        menu_podswietlenie(31,30,'Zmieä',0);
                        if polozenie1 <> 3 then gotoxy(50,19+(polozenie1*4));
                        if (litera1 = #13) and (polozenie1<>3) then
                                begin
                                        ...
                                        if length(test1) = 10 then      //je¾eli hasˆo ma 10 liter to bˆ¥d
                                                begin
                                                        gotoxy(50,19+(polozenie1*4));
                                                        write('          ');
                                                        gotoxy(36,36);
                                                        write('Zbyt dˆugie hasˆo...');
                        ...
                        if polozenie1 = 3 then menu_podswietlenie(31,30,'Zmieä',1); //okienko
                                                                                      // zatwierdzenia zmian
                ...
                begin
                        gotoxy(30,36);
                        write(godzina,' - Czy zakoäczy† (');  //wzbogacenie kolorystyczne pytania
                        cznieb;
                        write('t');
                        typowyk;
                        write('/');
                ...
                if udanazm = true then
                        begin
                                gotoxy(36,22);
                                write('Zapisano nowe hasˆo...');
                                writeln(tt,godzina,' - Zapisanie nowego hasla');
                        end
                        else
                        begin
                                gotoxy(33,22);
                                write('Niepoprawne hasˆo aktualne !');
...
begin
        ...
        if fsearch('logi\kopie_z\haslo.mss','') = '' then   //gdy brak hasla pobierz je i zakoduj do pliku
                begin
                        ...
                        repeat
                                wpisaniehasla:
                                litera:=readkey;        //p©tla wpisania hasˆa
                        ...
                        gotoxy(50,19);
                        gotoxy(31,15);
                        writeln('Masz 3 pr¢by na wpisanie hasˆa.');
                        gotoxy(34,22);
                        write('Dla bezpieczeästwa wpisz');
                        gotoxy(36,23);
                        write('hasˆo jeszcze raz...');
                        gotoxy(50,19);
        ...
        if ogranicz=true then
                begin
                        ...
                        gotoxy(31,26);
                        write(' Skontaktuj si© z wˆa˜cicielem');
                        gotoxy(31,27);
        ...
        repeat
                ...
                begin
                        menu_podswietlenie(x,y,'Kalkulator',0);
                        menu_podswietlenie(x,y+4,'Menu wpisania hasˆa',0);
                        menu_podswietlenie(x,y+8,'O Autorze',0);
                        menu_podswietlenie(x,y+12,'Kontakt',0);

                        if polozenie = 1 then menu_podswietlenie(x,y,'Kalkulator',1);
                        if polozenie = 2 then menu_podswietlenie(x,y+4,'Menu wpisania hasˆa',1);
                        if polozenie = 3 then menu_podswietlenie(x,y+8,'O Autorze',1);
                        if polozenie = 4 then menu_podswietlenie(x,y+12,'Kontakt',1);
                end;
                ...
                if klawisz = #13 then
                        begin
                                ...
                                begin
                                        ...
                                        if polozenie = 2 then
                                                begin
                                                        menu_podswietlenie(x,y+4,'Menu wpisania hasˆa',1);
                                                        a:=10;
                                                end;
                                        if polozenie = 3 then
                                                begin
