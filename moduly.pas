...
implementation
        ...
        begin
                ...
                if fsearch('logi\logi_kalk.txt','') = '' then
                        begin
                                writeln('Brakuje pliku raportowego, wˆa˜nie go wygenerowaˆem.');
                ...
                powtorzenie:=false;
                writeln('Dost©pne s¥ nast©puj¥ce dziaˆania: ');
                writeln;
                cznieb;
                write(' 1');
                typowyk;
                ...
                write(' 5');
                typowyk;
                writeln(') Dielenie caˆkowite/modulo');
                cznieb;
                write(' 6');
                typowyk;
                writeln(') Pot©gowanie');
                ...
                if (d > 8) then
                        begin
                                writeln('Nie ma takiego dziaˆania.');
                                writeln();
                                goto kalk2;
                        end;
                ...
                case d of
                        1:
                                begin
                                        write('Wybraˆe˜ dodawanie, podal liczb© a: ');
                                        readln(a);
                                        writeln();
                                        write('Podaj liczb© b: ');
                                        readln(b);
                        ...
                        2:
                                begin
                                        write('Wybraˆe˜ odejmowanie, podal liczb© a: ');
                                        readln(a);
                                        writeln();
                                        write('Podaj liczb© b: ');
                                        readln(b);
                        ...
                        3:
                                begin
                                        write('Wybraˆe˜ mno¾enie, podal liczb© a: ');
                                        readln(a);
                                        writeln();
                                        write('Podaj liczb© b: ');
                                        readln(b);
                        ...
                        4:
                                begin
                                        write('Wybraˆe˜ dzielenie, podal liczb© a: ');
                                        readln(a);
                                        writeln();
                                        write('Podaj liczb© b: ');
                                        readln(b);
                        ...
                        5:
                                begin
                                        writeln('Wybraˆe˜ dzielenie caˆkowite/modulo.');
                                        writeln();
                                        write('Musisz poda† liczby caˆkowite, podaj liczb© a: ');
                                        readln(a);
                                        e:=trunc(a);
                                        if a <> e then writeln('Podaˆe˜ mi liczb© z uˆamkiem, musiaˆem zaokr¥gli†...');
                                        writeln();
                                        write('Podaj liczb© b: ');
                                        readln(b);
                                        f:=trunc(b);
                                        if b <> f then writeln('Podaˆe˜ mi liczb© z uˆamkiem, musiaˆem zaokr¥gli†...');
                                        writeln();
                                        writeln('Iloraz caˆkowity liczb ',e, ' i ',f, ' jest r¢wny ', e div f, ', reszta z dzielenia to ',e mod f, '.');
                                        write(e,' ');
                                        cznieb;
                                        write('div');
                                        typowyk;
                        ...
                        6:
                                begin
                                        write('Wybraˆe˜ pot©gowanie, podal podstaw© pot©gi: ');
                                        readln(a);
                                        writeln;
                                        write('Podaj wykˆadnik pot©gi:');
                                        readln(b);
                                        f:=trunc(b);
                                        if b <> f then writeln('Podaˆe˜ mi liczb© z uˆamkiem, musiaˆem zaokr¥gli†...');
                                        b:=1;
                                        ...
                                        begin
                                                ...
                                                writeln();
                                                writeln('Pot©ga liczby ',a:1:c,' o wykˆ. ',f,' jest r¢wna ', b:1:c, '.');
                                                write(a:1:c,' ');
                                                cznieb;
                                                write('^');
                                                typowyk;
                                        ...
                                        begin
                                                ...
                                                writeln();
                                                writeln('Pot©ga liczby ',a:1:c,' o wykˆ. ',f,' jest r¢wna ',1/b:1:c, '.');
                                                write(a:1:c,' ');
                                                cznieb;
                                                write('^');
                                                typowyk;
                        ...
                        7:
                                begin
                                        write('Wybraˆe˜ pierwiastkowanie, podal liczb© a: ');
                                        readln(a);
                                        writeln();
        ...
        begin
                ...
                writeln('ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ» ');
                writeln('º  _____                           _                      _     _ _             _      º ');
                writeln('º |  _  |                         (_)                    | |   (_) |           | |     º ');
                writeln('º | | | |_ __   ___ _ __ __ _  ___ _  ___   _ __   __ _  | |__  _| |_ __ _  ___| |__   º ');
                writeln('º | | | | `_ \ / _ \ `__/ _` |/ __| |/ _ \ | `_ \ / _` | | `_ \| | __/ _` |/ __| `_ \  º ');
                writeln('º \ \_/ / |_) |  __/ | | (_| | (__| |  __/ | | | | (_| | | |_) | | |_ (_| | (__| | | | º ');
                writeln('º  \___/| .__/ \___|_|  \__,_|\___| |\___| |_| |_|\__,_| |_.__/|_|\__\__,_|\___|_| |_| º ');
                writeln('º       | |                      _/ |                                                  º ');
                writeln('º       |_|                     |__/                                                   º ');
                writeln('ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»   Mikoˆaj Stankowiak, 09.08.2012r   ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼ ');
                writeln('                        º                                     º                                     ');
                writeln('                        ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼                             ');
                ...
                writeln();
                writeln('Obsˆugiwane liczby w zakresie od 1 do 1023.');
                writeln('Obsˆugiwany wsp¢ˆczynnik przesuni©cia L/P od 1 do 10.');
                writeln;

                op_bit1:
                if licznik = 7 then error('logi\logi_opbit.txt');
                 write('Wybierz numer dziaˆania: ');
                 readln(a);
                 if a <= 0 then
                        begin
                                writeln('Warto˜† musi by† wi©ksza od zera.');
                ...
                case a of
                        1:
                                begin
                                        kotwica2:
                                        write('Wybraˆe˜ przesuni©cie w lewo, podaj liczb© a: ');
                                        readln(b);
                                        if (b > 1023) or (b < 1) then
                                                begin
                                                        if licznik = 7 then error('logi\logi_opbit.txt');;
                                                        writeln;
                                                        writeln('Podaˆe˜ zˆ¥ liczb© !');
                                                        writeln;
                                                        licznik:=licznik+1;
                                                        goto kotwica2;
                                                end;
                                        ...
                                        kotwica21:
                                        write('Podaj wsp¢ˆczynnik przesuni©cia: ');
                                        readln(c);
                                        if (c > 10) or (c < 1) then
                                                begin
                                                        if licznik = 7 then error('logi\logi_opbit.txt');
                        ...
                        2:
                                begin
                                        kotwica3:
                                        write('Wybraˆe˜ przesuni©cie w prawo, podaj liczb© a: ');
                                        readln(b);
                                        if (b > 1023) or (b < 1) then
                                                begin
                                                        if licznik = 7 then error('logi\logi_opbit.txt');
                        ...
                        3:
                                begin
                                        kotwica4:
                                        write('Wybraˆe˜ koniukcj© (AND), podaj liczb© a: ');
                                        readln(b);
                                        if (b > 1023) or (b < 1) then
                                                begin
                                                        if licznik = 7 then error('logi\logi_opbit.txt');
                        ...
                        4:
                                begin
                                        kotwica5:
                                        write('Wybraˆe˜ alternatyw© (OR), podaj liczb© a: ');
                                        readln(b);
                                        if (b > 1023) or (b < 1) then
                                                begin
                                                        if licznik = 7 then error('logi\logi_opbit.txt');
                        ...
                        5:
                                begin
                                        kotwica6:
                                        write('Wybraˆe˜ sum© symetryczn¥ (XOR), podaj liczb© a: ');
                                        readln(b);
                                        if (b > 1023) or (b < 1) then
                                                begin
                                                        if licznik = 7 then error('logi\logi_opbit.txt');
        ...
        begin
                ...
                writeln('ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ» ');
                writeln('º  _____              _ _                _ _        _          _                 _       _      º ');
                writeln('º |  __ \            | (_)              (_) |      (_)        | |               | |     | |     º ');
                writeln('º | |__) | __ _______| |_  ___ _____ __  _| | __    _  ___  __| |_ __   ___  ___| |_ ___| | __  º ');
                writeln('º |  ___/ `__|_  / _ \ | |/ __|_  / `_ \| | |/ /   | |/ _ \/ _` | `_ \ / _ \/ __| __/ _ \ |/ /  º ');
                writeln('º | |   | |   / /  __/ | | (__ / /| | | | |   <    | |  __/ (_| | | | | (_) \__ \ ||  __/   <   º ');
                writeln('º |_|   |_|  /___\___|_|_|\___/___|_| |_|_|_|\_\   | |\___|\__,_|_| |_|\___/|___/\__\___|_|\_\  º ');
                writeln('º                                                 _/ |                                          º ');
                writeln('º                                                |__/                                           º ');
                writeln('º                                                                                               º ');
                writeln('ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»   Mikoˆaj Stankowiak, 09.08.2012r   ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼ ');
                writeln('                             º                                     º                                ');
                writeln('                             ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼                                ');
                ...
                case b of
                        1:
                                begin
                                        if powtorzenie = false then
                                        begin
                                                writeln('Wybraˆe˜ przeliczanie w jednostkach dˆugo˜ci.');
                        ...
                        2:
                                begin
                                        if powtorzenie = false then
                                        begin
                                                writeln('Wybraˆe˜ przeliczanie w jednostkach powierzchni.');
                        ...
                        3:
                                begin
                                        if powtorzenie = false then
                                        begin
                                                writeln('Wybraˆe˜ przeliczanie w jednostkach obj©to˜ci.');
                        ...
                        4:
                                begin
                                        if powtorzenie = false then
                                        begin
                                                writeln('Wybraˆe˜ przeliczanie w jednostkach czasu.');
                        ...
                        5:
                                begin
                                        if powtorzenie = false then
                                        begin
                                                writeln('Wybraˆe˜ przeliczanie w jednostkach pr©dko˜ci.');
                        ...
                        6:
                                begin
                                        if powtorzenie = false then
                                        begin
                                                writeln('Wybraˆe˜ przeliczanie w jednostkach temperatury.');
                        ...
                        7:
                                begin
                                        if powtorzenie = false then
                                        begin
                                                writeln('Wybraˆe˜ przeliczanie w jednostkach mocy.');
                        ...
                        8:
                                begin
                                        if powtorzenie = false then
                                        begin
                                                writeln('Wybraˆe˜ przeliczanie w jednostkach masy.');
                        ...
                        9:
                                begin
                                        if powtorzenie = false then
                                        begin
                                                writeln('Wybraˆe˜ przeliczanie w jednostkach danych.');
        ...
        begin
                poczatek:
                clrscr;
                writeln('ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»');
                writeln('º    __ __        __          ___      __           __         º');
                writeln('º   / //_/__  ___/ /__ ____  / _ \___ / /_____  ___/ /__ ____  º');
                writeln('º  / ,< / _ \/ _  / -_) __/ / // / -_)  `_/ _ \/ _  / -_) __/  º');
                writeln('º /_/|_|\___/\_,_/\__/_/   /____/\__/_/\_\\___/\_,_/\__/_/     º');
                writeln('º                                                              º');
                writeln('ÈÍÍÍÍÍÍÍÍÍÍÍÍ»   Mikoˆaj Stankowiak, 09.08.2012r   ÉÍÍÍÍÍÍÍÍÍÍÍ¼');
                writeln('             º                                     º             ');
                writeln('             ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼             ');
                cznieb;
                gotoxy(4,9);
                ...
                if klawisz=#13 then
                        begin
                                ...
                                begin                             //gdy za dˆugi ci¥g znak¢w
                                        gotoxy(x,yruchome);
                                        typowyk;
                                        write('                                                           ');
                                        gotoxy(x*2,y+7);
                                        write(godzina,' - za dˆugi');
                                        gotoxy(x*2,y+8);
                                        write('ci¥g znak¢w !');
                                        goto poczpetli;
                                end;
        ...
        begin
                ...
                writeln('ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ» ');
                writeln('º                                                                                    º ');
                writeln('º .|```|                    ||`                                                      º ');
                writeln('º ||                        ||            ``                                         º ');
                writeln('º `|```|, `||``| .|``|, .|``||  `||``|,   ||   ```|.     .|``|, .|``, .|``|, `||``|, º ');
                ...
                writeln('º |...|` .||.   `|...  `|..||. .||  ||. .||. `|..||.    `|..|` `|..` `|...  .||  ||. º ');
                writeln('º                                                                                    º ');
                writeln('ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»   Mikoˆaj Stankowiak, 09.08.2012r   ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼');
                writeln('                       º                                     º                     ');
                writeln('                       ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼                      ');
                ...
                writeln;
                write('Podaj dokˆadno˜† ˜redniej w miejscach po przecinku: ');
                readln(dokl);
                                ...
                                if ocenay <3 then
                                        begin                                        // zaznaczenie i przypisanie warto˜ci do tabeli
                                                ...
                                                if (((liczba > 6) or (liczba < 1)) and (ocenay = 1)) or (((liczba > 12) or (liczba < 0)) and (ocenay = 2)) then
                                                        begin   //komunikat o bˆ©dnej liczbie
                                                                gotoxy(21,28);
                                                                typowyk;
                                                                writeln(godzina,' - Zˆa liczba !');
                                                                goto pocz_tabeli;
                                                        end
        ...
        begin
                ...
                writeln('º ______            _    _           _                               º ');
                writeln('º | ___ \          | |  | |         (_)                              º ');
                writeln('º | |_/ /   _ _ __ | | _| |_ _   _   _    ___   ___ ___ _ __   __ _  º ');
                writeln('º |  __/ | | | `_ \| |/ / __| | | | | |  / _ \ / __/ _ \ `_ \ / _` | º ');
                writeln('º | |  | |_| | | | |   <| |_| |_| | | | | (_) | (_|  __/ | | | (_| | º ');
                writeln('º \_|   \__,_|_| |_|_|\_\\__|\__, | |_|  \___/ \___\___|_| |_|\__,_| º ');
                writeln('º                             __/ |                                  º ');
                writeln('º                            |___/                                   º ');
                writeln('º                                                                    º ');
                writeln('ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»   Mikoˆaj Stankowiak, 09.08.2012r   ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼');
                writeln('                º                                     º                     ');
                writeln('    v. 2.03     ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼                      ');
                ...
                if fsearch('logi\logi_punkty.txt','') = '' then //sprawdza czy istnieje plik z logami
                        begin                       //jezeli nie to go tworzy
                                ...
                                write('wˆa˜nie go wygenerowaˆem.');
                ...
                gotoxy(x,y-2);
                writeln('Dane ucznia nr ',nrd,' (uzupeˆnij):');
                typowyk;
                gotoxy(x,y);
                ...
                gotoxy(x,y+21);
                write('Je¾eli wpisaˆe˜ wszystkie dane to wci˜nij k aby');
                gotoxy(x,y+22);
                write('kontynuowa†...');
                x:=x+18;
                ...
                begin
                        if znak=chr(0) then znak:=readkey; //je¾eli strzaˆki
                ...
                for licznik:=1 to ilosczad do
                        ...
                        end;                    // obliczanie gˆownego wyniku
                for licznik:=1 to ilosczad do
                        begin
                ...
                textbackground(11);
                typowyk;
                if tabelay < 3 then gotoxy(ruchomex,ruchomey);  // ustaw kursor po wci˜ni©ciu strzaˆki
                if tabelay = 4 then
                        begin
                                case ktorynapis of
                                1: gotoxy(x-11,y+9);
        ...
        poczatek:
        clrscr;
        writeln('ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»');
        writeln('º  ___                              _               _     _                                      º');
        writeln('º (  _`\                           (_ )            ( )   ( )                     //              º');
        writeln('º | |_) ) _ __  ____    __     __   | |    _ _    _| |   | |       _      __     _    _   _   _  º');
        writeln('º | ,__/`( `__)(_  ,) /`__`\ /`_ `\ | |  /`_` ) /`_` |   | |  _  /`_`\  /`_ `\ /`_`\ ( ) ( ) ( ) º');
        writeln('º | |    | |    /`/_ (  ___/( (_) | | | ( (_| |( (_| |   | |_( )( (_) )( (_) |( (_) )| \_/ \_/ | º');
        writeln('º (_)    (_)   (____)`\____)`\__  |(___)`\__,_)`\__,_)   (____/``\___/``\__  |`\___/``\___x___/` º');
        writeln('º                            ___) |                                     ___) |                   º');
        writeln('º                            \___/`                                     \___/`                   º');
        writeln('º                                                                                                º');
        writeln('ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»   Mikoˆaj Stankowiak, 09.08.2012r   ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼');
        writeln('                             ÈÍÍ»                               ÉÍÍ¼                              ');
        writeln('                                ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹                                 ');
        writeln('                                º                               º                                 ');
        writeln('                                º    Wybierz plik z logami:     º                                 ');
        writeln('                                º                               º                                 ');
        writeln('                                ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹                                 ');
        writeln('       Wci˜nij Enter aby        º                               º         Wpisz openbackup        ');
        writeln('          otworzy† log          º                               º        aby otworzy† kopi©       ');
        writeln('                                º                               º          zapasow¥ logu          ');
        writeln('                                ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹                                 ');
        writeln('        Wci˜nij DEL aby         º                               º        Wpisz deletebackup       ');
        writeln('          usun¥† log            º                               º         aby usun¥† kopi©        ');
        writeln('                                º                               º          zapasow¥ logu          ');
        writeln('                                ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹                                 ');
        writeln('        Wci˜nij ESC aby         º                               º                                 ');
        writeln('             wyj˜†              º                               º                                 ');
        writeln('                                º                               º                                 ');
        writeln('                                ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹                                 ');
        writeln('                                º                               º                                 ');
        ...
        if fsearch('logi\logi_przeglad.txt','') = '' then
                begin
                        ...
                        writeln(godzina,' - Brakuje pliku raportowego,');
                        gotoxy(37,37);
                        writeln('wˆa˜nie go wygenerowaˆem.');
        ...
        case a of
                0:
                 ...
                 11:                                 //usuwanie i kopia bezpieczeästwa
                  begin
                 ...
                 18:                                 //usuwanie i kopia bezpieczeästwa
                  begin
